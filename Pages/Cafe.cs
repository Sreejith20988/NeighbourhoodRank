...
namespace NeighbourhoodRank
{
    ...
    public partial class Cafe
    {
        public static Cafe[] FromJson(string json) => JsonConvert.DeserializeObject<Cafe[]>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Cafe[] self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
