namespace CafeSpace
{
    ...
    public partial class Cafe
    {
        public static List<Cafe> FromJson(string json) => JsonConvert.DeserializeObject<List<Cafe>>(json, CafeSpace.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Cafe> self) => JsonConvert.SerializeObject(self, CafeSpace.Converter.Settings);
    }
