namespace EnergyPackage
{
    ...
    public partial class Energy
    {
        public static Energy[] FromJson(string json) => JsonConvert.DeserializeObject<Energy[]>(json, EnergyPackage.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Energy[] self) => JsonConvert.SerializeObject(self, EnergyPackage.Converter.Settings);
    }
